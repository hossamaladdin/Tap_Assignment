...
rds_multi_az                                = false # Single-AZ for dev to save costs
rds_publicly_accessible                     = false
rds_deletion_protection                     = false # Allow deletion in dev
rds_skip_final_snapshot                     = true  # Skip final snapshot in dev
...
enable_bastion                 = false # Set to true if you need bastion access
