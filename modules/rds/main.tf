...
resource "aws_db_parameter_group" "sqlserver" {
  ...
  tags = merge(var.tags, { Name = "${var.name_prefix}-sqlserver-parameter-group" })
...
resource "aws_db_option_group" "sqlserver" {
  ...
  tags                     = merge(var.tags, { Name = "${var.name_prefix}-sqlserver-option-group" })
...
resource "aws_db_instance" "sqlserver" {
  ...
  tags                                  = merge(var.tags, { Name = "${var.name_prefix}-sqlserver" })
